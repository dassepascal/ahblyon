    ...
    <div class="p-5 mb-4 bg-light rounded-3 mt-5">
            ...
            <div class="card ">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p class="card-text">Découvrez notre association humanitaire à travers notre histoire, nos valeurs,
                            notre équipe, et
        ...
        <div class="card">
            <div class="card-body">
                    <div class="mb-4">
                        <div class="card-title">
                            <h5 class=" ">Projets et réalisations</h5>
                            <a href="{{ asset('projets') }}" class="btn btn-primary"> Découvrez </a>
                        </div>
                    </div>
            </div>
        </div>
